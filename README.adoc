...
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/data-sources/service[kubernetes_service.trino] (data source)
...
==== [[input_pinot_dns]] <<input_pinot_dns,pinot_dns>>
...
|[[output_cluster_dns]] <<output_cluster_dns,cluster_dns>> |trino cluster dns
|[[output_cluster_ip]] <<output_cluster_ip,cluster_ip>> |trino cluster ip internal
|[[output_endpoint]] <<output_endpoint,endpoint>> |trino endpoint external
|===
// END_TF_TABLES
====
